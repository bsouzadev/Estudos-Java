...
public class Calculadora {
    ...
    // Para um método, é necessário um modificador de acesso, um tipo de retorno (ou
    // indicar que não retorna nada) e um nome.
    ...
    // Passagem por valor tipo primitivo: o número original não é alterado, pois é
    // criada uma cópia dele.
    ...
    // metodo VarArgs
    public void somaVarArgs(int... num) { //tipo... e o nome da variavel.
        int soma = 0;
        for (int i = 0; i < num.length; i++) {
            soma += num[i];
        }
