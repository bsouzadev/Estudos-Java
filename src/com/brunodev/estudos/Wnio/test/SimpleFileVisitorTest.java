...
public class SimpleFileVisitorTest {
    static void main(String[] args) throws IOException {
        ...
        Path path = Paths.get(".");
        Files.walkFileTree(path, new ListJavaFiles()); //Nos parâmetros precisa de um path para começar a procurar e o comportamento do que se quer fazer navegando por esses diretórios.
    }
}
